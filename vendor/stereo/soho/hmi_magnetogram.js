Stereo.soho.soho_hmi_magnetogram = function(){
	...
	var _load = function (query){
		...
		$.get("http://sohodata.nascom.nasa.gov/cgi-bin/data_query_search_url?Session=web&Resolution="+query["quality"]+"&Display=Images&NumImg="+query["num_img"]+"&Types=instrument=HMI:obs_type=Magnetogram").done(_parse);
	};
