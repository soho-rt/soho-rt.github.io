Stereo.soho.soho_eit_195 = function(){
	...
	var _load = function (query){
		...
		var url = encodeURIComponent("http://sohodata.nascom.nasa.gov/cgi-bin/data_query_search_url?Session=web&Resolution="+query["quality"]+"&Display=Images&NumImg="+query["num_img"]+"&Types=instrument=EIT:wavelength=195");
	...
	function _parse(response){
		if(!response || response.length === 0){ 
			Stereo.soho.warn("[EIT/195] _parse:function - Server no response.");
