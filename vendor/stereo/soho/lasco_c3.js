Stereo.soho.soho_lasco_c3 = function(){
	...
	var _load = function (query){
		...
		$.get("http://sohodata.nascom.nasa.gov/cgi-bin/data_query_search_url?Session=web&Resolution="+query["quality"]+"&Display=Images&NumImg="+query["num_img"]+"&Types=instrument%3DLASCO%3Adetector%3DC3").done(_parse);
	};
